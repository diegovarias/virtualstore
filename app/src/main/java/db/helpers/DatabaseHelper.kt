...
class DatabaseHelper(context: Context) : SQLiteOpenHelper(context, DATABASE_NAME, null, DATABASE_VERSION) {
    ...
    companion object {
        ...
        private const val SQL_CREATE_CART_ITEMS = "CREATE TABLE ${CartItemContract.CartItemEntry.TABLE_NAME} (" +
        ...
        private const val SQL_DELETE_CART_ITEMS = "DROP TABLE IF EXISTS ${CartItemContract.CartItemEntry.TABLE_NAME}"

        private const val SQL_CREATE_CLIENTS = "CREATE TABLE ${ClientContract.ClientEntry.TABLE_NAME} (" +
        ...
        private const val SQL_DELETE_CLIENTS = "DROP TABLE IF EXISTS ${ClientContract.ClientEntry.TABLE_NAME}"

        private const val SQL_CREATE_PRODUCTS = "CREATE TABLE ${ProductContract.ProductEntry.TABLE_NAME} (" +
        ...
        private const val SQL_DELETE_PRODUCTS = "DROP TABLE IF EXISTS ${ProductContract.ProductEntry.TABLE_NAME}"
    }
}
